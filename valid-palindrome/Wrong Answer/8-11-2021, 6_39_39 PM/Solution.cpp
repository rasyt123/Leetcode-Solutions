    ...
    bool isPalindrome(string s) {
        ...
        */
        ...
        while (l < r) {
            s[l] = tolower(s[l]);
            s[r] = tolower(s[r]);
            while ((isspace(s[l]) or !((s[l] >= 97 and s[l] <= 122) or (s[l] >= 48 and s[l] <= 57))) and l < s.size() - 1) {
                ++l;
            }
            while ((isspace(s[r]) or !((s[r] >= 97 and s[r] <= 122) or (s[r] >= 48 and s[r] <= 57))) and r > 0) {
                --r;
            }


            if(s[l] == s[r] or !((s[l] >= 97 and s[l] <= 122) or (s[l] >= 48 and s[l] <= 57)) or !((s[r] >= 97 and s[r] <= 122) or (s[r] >= 48 and s[r] <= 57))) {
                ++l;
                --r;
            } else {
                return false;
